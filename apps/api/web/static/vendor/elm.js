...
var _user$project$Main$decode = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
	...
	function (flags, location) {
		var model = function () {
			var _p1 = A2(
				...
				_user$project$Main$debugDecoder(_user$project$Main$decode),
				flags);
			if (_p1.ctor === 'Ok') {
				return _p1._0;
			} else {
				return _user$project$Main$Error(_p1._0);
			}
		}();
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
	...
	function (msg, model) {
		...
		do {
			if (_p2.ctor === '_Tuple2') {
				switch (_p2._0.ctor) {
					case 'SourcesMsg':
						if (_p2._1.ctor === 'Index') {
							var _p3 = A2(_user$project$Sources$update, _p2._0._0, _p2._1._0);
							var newSources = _p3._0;
							var cmd = _p3._1;
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
					...
					case 'EntriesMsg':
						if (_p2._1.ctor === 'Show') {
							var _p4 = A2(_user$project$Entries$update, _p2._0._0, _p2._1._0);
							var newEntries = _p4._0;
							var cmd = _p4._1;
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
						...
						return A2(
							...
							model,
							{
								...
								_0: A3(
									...
									A2(_elm_lang$core$Basics_ops['++'], '/api', _p2._0._0.pathname),
					...
					default:
						if (_p2._0._0.ctor === 'Ok') {
							...
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_user$project$Main$Error(_p2._0._0._0),
								{ctor: '[]'});
						}
				}
			} else {
...
var _user$project$Main$view = function (model) {
		...
		switch (_p5.ctor) {
			case 'Index':
				return A2(
					...
					_user$project$Sources$view(_p5._0));
			case 'Show':
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$EntriesMsg,
					_user$project$Entries$view(_p5._0));
			default:
	...
	return _user$project$Main$mainView(html);
};
